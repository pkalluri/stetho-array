listeners = getAllStethosAsRecorders(LISTENER_NAME_SIGNATURE, SAMPLING_RATE, SAMPLE_SIZE, NUMBER_OF_CHANNELS);
blockingSimultaneousRecord(listeners, RECORDING_DURATION); %listen
listeners_signals = recordersToSignals(listeners);
